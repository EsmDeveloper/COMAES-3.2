 ...
 * 2. Card da sequência de aprendizagem com ícone de chama e dias consecutivos
 * 3. Lista das últimas 5 conquistas desbloqueadas (com ícones)
 * 4. Posição nos rankings (global e por categoria) com link para página de rankings
 * 5. Missões ativas do dia/semana (máximo 3) com progresso
 * 6. Mini gráfico de evolução de XP nos últimos 30 dias (opcional)
 */
...
const MinhaJornada = () => {
  ...
  const data = gamificacaoData || {
    ...
    conquistas: [
      ...
      { id: 4, titulo: "Participante Ativo", descricao: "10 questões respondidas", icone: "✅", data: "2024-01-22" },
    ...
    rankings: {
      ...
      categorias: [
        ...
        { categoria: "Inglês", posicao: 25, total: 400 }
      ]
    },
    missoes: [
      { id: 1, titulo: "Dia de Desafio", descricao: "Responda 5 questões hoje", progresso: 3, total: 5, tipo: "diaria" },
      { id: 2, titulo: "Explorador", descricao: "Complete 1 torneio esta semana", progresso: 0, total: 1, tipo: "semanal" },
      { id: 3, titulo: "Mestre do Conteúdo", descricao: "Alcance 1000 XP", progresso: 720, total: 1000, tipo: "longo_prazo" }
    ],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Bloco 2: Sequência de Aprendizagem */}
            <motion.div
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600">
                        {data.streak.ativa ? '🔥 Seu hábito está ativo!' : 'Recomece sua sequência hoje!'}
                      </p>
                    </div>
                  </div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Últimas 5 conquistas desbloqueadas</p>
                </div>
                <Link 
                  to="/conquistas" 
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Veja como está em relação à comunidade</p>
                </div>
                <Link 
                  to="/ranking" 
                  className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1"
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Complete missões para ganhar XP</p>
                </div>
                <Link 
                  to="/missoes" 
                  className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1"
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Últimos 30 dias de aprendizado</p>
                </div>
                <span className="text-sm text-gray-500">
                  <FaChartLine className="inline mr-1" />
                  Tendência: <span className="font-bold text-green-600">+{Math.floor(data.xpTotal / 30)} XP/dia</span>
                </span>
              </div>
