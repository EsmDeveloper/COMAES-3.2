...
/**
 * QuestoesManager
 * Gerenciador de questÃães usando modelo Ãºnico Questao.js
 */
...
const QuestoesManager = () => {
  ...
  const carregarQuestoes = async () => {
    ...
    try {
      ...
      setError('Erro ao carregar questÃães');
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600">
              Crie, edite e gerencie questÃães usando o modelo Ãºnico Questao.js
            </p>
          </div>
          <button
            ...
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-gradient-to-r from-slate-50 to-blue-50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right font-semibold text-slate-700">AçÃães</th>
                </tr>
              </thead>
