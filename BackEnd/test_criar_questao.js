...
async function test() {
  try {
    ...
    console.log('\n2️⃣ Encontrando colaborador aprovado...');
    ...
    console.log(`✅ Encontrado: ${colaborador.nome} (ID=${colaborador.id})`);

    // 3. Gerar token JWT
    console.log('\n3️⃣ Gerando JWT token...');
    ...
    console.log('\n4️⃣ Payload da questão:');
    console.log(JSON.stringify(questaoPayload, null, 2));

    // 5. Fazer request POST
    console.log('\n5️⃣ Fazendo POST para /api/colaborador/questoes...');
